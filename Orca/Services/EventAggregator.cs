...
namespace Orca.Services
{
    ...
    public class EventAggregator : IEventAggregator
    {
        ...
        public EventAggregator(ISharepointManager sharePointManager, ICourseCatalog courseCatalog, ILogger<EventAggregator> logger)//, Controllers.NotificationsController notificationsController)
        {
        ...
        {
            // Check whether joinWebURL exist in the courseCatalog.
            /*if (_courseCatalog.CheckJoinWebURLExist(_joinWebUrl))
            {
                // Check the corresponding courseID of this joinWebUrl according to Catalog.
                targetCourseID = _courseCatalog.GetCourseIDForJoinWebURL(_joinWebUrl);

                // Check whether courseId exist in the courseCatalog.
                if (_courseCatalog.CheckCourseIdExist(targetCourseID))
                {
